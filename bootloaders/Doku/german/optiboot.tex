...
ein Start-Bit richtig erkannt, es ist aber das falsche Zeichen.
...
wenn auch das EEprom-Laden unterstützt wird (SUPPORT\_EEPROM=1).
...
wieder möglich. Derzeit kann nur die SOFT\_UART Funktion nicht zusammen
mit der Baudratenmessung benutzt werden.
