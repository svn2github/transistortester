...
\item Automatische Erkennung des Pin Anschl\"usse der erkannten Bauteile.
...
Der Wert kann zwischen 35pF (bei 8MHz Takt, 70pF bei 1MHz Takt) bis 40mF mit einer Aufl\"osung von bis zu 1pF (bei 8MHz Takt).
...
\item Kondensatoren mit Kapazit\"atswerten von unter 35pF werden normalerweise nicht erkannt, 
aber sie k\"onnen zusammen mit einer parallel geschalteten Diode oder mit einem parallel geschaltetem Kondensator mit
wenigstens 35pF gemessen werden.
