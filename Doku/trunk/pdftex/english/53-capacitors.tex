...
The figure~\ref{pic:esr4} shows a part of the voltage curve of a \(4.2\mu F\) capacitor pin, measured to ground potential,
 during the ESR measurement.

\begin{figure}[H]
  \centering
    \includegraphics[]{../PNG/ESR_4uF.png}
  \caption{Voltage curve at one pin of a \(4.2\mu F\) capacitor during ESR measurement}
  \label{pic:esr4}
\end{figure}
