...
\item For capacitors with a capacity value above \(4 \mu F\) the Equivalent Serial Resistance (ESR) is measured 
...
and \(3 \mu F\) connected to pin~1 and pin~3 is necessary to compensate the offset voltage of the analog comparator.
