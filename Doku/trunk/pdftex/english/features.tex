...
\item Selectable facility for ATmega168 or ATmega328, to calibrate
the internal port resistance of port output and
the zero offset of capacity measurement with the selftest.
