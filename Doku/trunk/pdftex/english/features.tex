...
\end{picture}
and value.  The value can be from 25pF (8MHz clock, 50pF @1MHz clock) to 100mF with a resolution of up to 1 pF (@8MHz clock].
...
your ATmega has more than 8K flash memory.
The range will be from about 0.04 mH to more than 20 H, but the accuracy is not good.
