...
This test and the follwing tests willonly be done, if the option AUTO\_CAL is selected.
...
The result for this test will then be notified in row 1, the resistance value to the GND side is
displayed in row 2 .
