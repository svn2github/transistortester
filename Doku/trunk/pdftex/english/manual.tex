...
if it not placed in a socket. You should also not touch to the isolation of wires connected with the test ports,
...
and the internal resistance of the port output. But for this feature the tests must be repeated all eight times for
building the mean values.
