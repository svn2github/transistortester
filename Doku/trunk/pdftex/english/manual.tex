...
building the mean values. If you connect a capacitor with at least \(100 nF\) to pin~1 and pin~3 during test step 10, the offset voltage
of the analog comparator will be compensated for better measurement of capacity values and the gain for ADC measurements
with the internal reference voltage will be adjusted too for better resistor measurement results with the AUTOSCALE\_ADC option.
