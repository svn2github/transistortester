...
The measurement can also be finished with a extra long key press (>~4~seconds).
...
short key press (<~0.2~s) only reset the time limit of 4~minutes.
With periodical short key press you can prevent the time out of the frequency generation.
With a long key press (>~0.8~s) you will stop the frequency generator and return to the function menu.\\
...
With a short key press (<~0.5~s) the pulse width is increased by \(1 \%\), with a longer key press the pulse width
is increased by \(10 \%\).
...
The frequency generation can also be finished with a very long key press (>~1.3~s).\\
