...
This will be marked with a ! character in column 1 of the second LCD row during the tests.
...
This will be noticed by a ! character in column one of the second LCD line during further tests.
