...
with the DD switch. The Input (PIN) can operate regardless to the state of the switch DD.
The PORT switch usually defined the output level, but also switched the pull up resistor.
