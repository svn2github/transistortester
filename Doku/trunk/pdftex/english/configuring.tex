...
capacitor with at least \(100 nF\) to pin~1 and pin~3 after measurement of capacity zero offset. 
...
The 8MHz operation is recommended for better resolution of capacity measurement.\\
example: OP\_MHZ = 8
