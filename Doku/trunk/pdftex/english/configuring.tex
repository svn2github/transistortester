...
If the ESR measurement results to a negativ value, the text ''ESR=?'' is displayed and the zero offset
in the EEprom memory will be corrected.
This corrected zero offset will be used for further measurements.
If you measure ESR values always too high, you should select a higher ESR\_ZERO value.\\
