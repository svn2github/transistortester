...
capacitor with alt least \(100 nF\) to pin 1 and pin 3 in the test No. 10. 
...
If you select the AUTO\_CAL option of the selftest section, this value is a offset to the found voltage 
