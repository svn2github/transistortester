...
\section{Extensions for the Transistor Tester}
...
If a graphical display with a ST7565 controller is used,
you must use the ATmega pin PD5 instead of the PD2 pin.
...
By now you can also connect a graphical 128x64 picel LCD with a ST7565 controller.
...
However the ST7565 controller requires a 3.3V power voltage and tolerates
no 5V signal level!
