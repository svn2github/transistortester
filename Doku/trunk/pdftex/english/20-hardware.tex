...
zeigt die Belegung der seriellen Anschlußsignale bei 
...
The table \ref{tab:7108-processor} shows the connection of a serial ST7108 controller
...
Signal:     &       &        &         \\
  ...
  PCLK      &  PB4  &  PA0   & PD0      \\
    ...
    \end{tabular}
  \end{center}
  \caption{Serieller ST7108 Anschluß für verschiedene Prozessoren}
