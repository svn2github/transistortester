...
A special case is the connection of displays with a NT7108 controller. Because these displays can only use 
...
You can also connect a display with the NT7108 controller ito the ATmega644 of ATmega1284 by using
