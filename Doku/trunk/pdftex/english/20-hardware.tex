...
the 8-bit parallel interface, you must use a serial to parallel converter. The simplest way seems to be the
use of a 74HCT164 chip. A suitable suggestion of a connection circuit shows the figure \ref{fig:ST7108lcd} .
