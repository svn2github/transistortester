...
example: WITH\_LCD\_ST7565 = 1 
 \item[LCD\_INTERFACE\_MODE] For the SSD1306 controller also the I2C type interface with address 0x3c
...
example: CFLAGS += -DLCD\_INTERFACE\_MODE=2
  \item[LCD\_I2C\_ADDR] The I2C address of the SSD1306 controller can be selected to 0x3d by presetting
