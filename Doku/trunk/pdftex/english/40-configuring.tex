...
All currently used code numbers are here shown for general view only: \\

\begin{table}[H]
  \begin{center}
    \begin{tabular}{| c | c |}
    \hline
 Code number &  Typ of interface \\
    \hline
    \hline
  1   & 4-bit parallel      \\
    \hline
  2   & I\textsuperscript{2}C-interface      \\
    \hline
  4   & 4-bit SPI interface      \\
    \hline
  5   & serial interface for the ST7920      \\
    \hline
  6   & serial interface for the ST7108 with 74HCT164  \\
    \hline
    \end{tabular}
  \end{center}
  \caption{Code numbers for the type of interface}
\end{table}
...
Selectable are FONT\_6X8, FONT\_8X8, FONT\_8X12, FONT\_8X14, FONT\_8X15, FONT\_8X16, and FONT\_8X16thin.
Currently the  8X12 font is not finished.
