...
If the measured capacitor has a capacity of more than about \(4 \mu F\), the tester will try to measure
the series resitance too.
The series resistance ESR is a good indicator for the aging of electrolytical capacitors for example.
...
Strictly speaking the ESR of a capacitor depends on the operating frequency.
...
To get the value of the equivalent series restistance,
...
The whole measurement sequence will be done 128 times and the results od the voltage measurements will be added.
So we have three sums of voltages, the voltage at the low side of the capacitor with current \(Ulp\), the voltage at
the high side of the capacitor with current \(Uhp\) and the voltage of the high side of the capacitor without current \(Uc\).
...
The voltage difference  of the high side and the low side of the capacitor reresents the voltage of the capacitor with
...
If the charge current will be switched off to late, the capacitor will be take more electric charge, than that of the
...
Anyway the results seems to be practical, as shown with the following table \ref{tab:esr_mes}.
...
\begin{table}[H]
  \begin{center}
    ...
    \hline
           & LCRmeter,100Hz & LCRmeter,1kHz & Transistortester & Transistortester \\
 capacitor   & capacity & Serial resistance & capacity & Serial resistance \\
           & \(\mu F\) & \(\Omega\) & \(\mu F\) & \(\Omega\) \\
    \hline
 4.4uF/100V & 4.19    &  0.25   & 4.197 &  0.35 \\
 10uF/100V & 9.91    &  0.06   & 9.953 &  0.05 \\
 10uF/Tantal & 11.7    &  0.86   & 12.95 &  0.87 \\
 10uF/350V & 9.37    &  1.72   & 9.90 &  1.73 \\
 47uF/25V & 44.9    &  0.93   & 47.33 &  0.95 \\
 68uF/100V & 64.1    &  0.09   & 66.6 &  0.10 \\
 50uF/50V &  81.3    &  0.62   & 85.84 & 0.68 \\
 100uF/25V & 161.5   &  0.29   & 167.7 & 0.30 \\
 220uF/63V & 234.5   &  0.09   & 246.7 & 0.08 \\
 330uF/50V & 313.1   &  0.07   & 328.8 & 0.08 \\
 470uF/35V & 440.7   &  0.02   & 460.8 & 0.02 \\
 500uF/3V  & 423.2   &  0.43   & 494.1 & 0.47 \\
 1000uF/35V & 961.9  &  0.01   & 1004 & 0.02 \\
 2200uF/40V & 2110   &  0.0    & 2250 & 0.02 \\
 4700uF/25V & 4620   &  0.0    & 5025 & 0.01 \\
    \hline
    \end{tabular}
  \end{center}
  \caption{Results of some ESR-measurements}
  \label{tab:esr_mes}
\end{table}
...
a good quality factor and should have a capacity between \(100 nF\) and \(3 \mu F\).
