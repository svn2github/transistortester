...
The differences of measurements of three different ATmega168 processors is shown in figure~\ref{fig:mega168all} .
...
not used.
Especially with the ATmega168 processors I have noticed a anomaly of measurement results, which depend on the slew rate of
the voltage during loading of the capacitor.
Figure~\ref{fig:mega168optcap} shows the error of the capacity measurement when only the zero value is respected
(168-A), with correction factor for little capacitors REF\_C\_KORR=66 as well as the correction factor for big
capacitors C\_H\_KORR=20 (168-B), plus additional as gradient 168-C  with a model of the slew rate dependency of little capacitor 
measurements (COMP\_SLEW1=4000 und COMP\_SLEW2=220).
