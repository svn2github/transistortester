...
\begin{figure}[H]
\centering
\input{../GNU/Mega328all}
\caption{capacity measurement error of three ATmega328, not calibrated}
\label{fig:mega328all}
\end{figure}

\begin{figure}[H]
\centering
\input{../GNU/Mega328Pall}
\caption{capacity measurement error of three ATmega328P, not calibrated}
...
\begin{figure}[H]
\centering
\input{../GNU/Mega328cal}
\caption{capacity measurement error of three ATmega328, calibrated}
\label{fig:mega328cal}
\end{figure}

\begin{figure}[H]
\centering
\input{../GNU/Mega328Pcal}
\caption{capacity measurement error of three ATmega328P, calibrated}
