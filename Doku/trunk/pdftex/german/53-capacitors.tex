...
Die Abbildung~\ref{pic:esr4} zeigt den Ausschnitt des Spannungsverlaufs einer \(4.2\mu F\) Kondensator-Seite
 während der ESR-Messung gegen Masse (GND) gemessen.

\begin{figure}[H]
  \centering
    \includegraphics[]{../PNG/ESR_4uF.png}
  \caption{Spannungsverlauf eines Pins während der ESR-Messung eines \(4.2\mu F\) Kondensators}
  \label{pic:esr4}
\end{figure}
