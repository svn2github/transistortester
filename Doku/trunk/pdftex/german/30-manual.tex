...
Nach dem Start der Funktion muss der Drehknopf gedreht werden.
Dabei wird der gemeinsame Anschluss herausgefunden und angezeigt, ob jede Raststellung beide Kontake offen ('o')
