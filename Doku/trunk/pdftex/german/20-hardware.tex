...
Die Makefile Option ,,WITH\_LCD\_ST7565 = 7920'' muß auf jeden Fall gesetzt werden, für die serielle
...
Einen Sonderfall stellen Displays mit ST7108 Controller dar. Da die Displays nur mit 8-Bit Parallelschnittstelle
angesteuert werden können, ist ein externer seriell-parallel Wandler erforderlich. Die einfachste Lösung 
scheint mir mit einem 74HCT164 Chip möglich zu sein. Einen entsprechenden Schaltungsvorschlag zeigt das
Bild \ref{fig:ST7108lcd} .

\begin{figure}[H]
\centering
\includegraphics[width=14cm]{../FIG/ST7108serial164.eps}
