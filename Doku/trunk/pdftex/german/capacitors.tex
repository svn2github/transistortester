...
Bei Kondensatoren mit mehr als etwa \(4 \mu F\) wird versucht den Serienwiderstand von Kondensatoren zu messen.
...
Genau genommen ist auch der ESR Widerstand eines Kondensators abh\"angig von der Betriebsfrequenz.
...
Trotzdem scheinen die Ergebnisse brauchbar zu sein, wie die nachfolgende Tabelle \ref{tab:esr_mes} zeigt.
...
\begin{table}[H]
 ...
 Bauteil   & Kapazit\"at & Serieller Widerstand & Kapazit\"at & Serieller Widerstand \\
 ...
 4700uF/25V & 4620   &  0.0    & 5025 & 0.01 \\
    ...
    \end{tabular}
  \end{center}
  \caption{Ergebnisse von ESR-Messungen}
  \label{tab:esr_mes}
\end{table}
...
Kapazit\"at zwischen \(100 nF\) und \(3 \mu F\) angeschlossen werden. 
