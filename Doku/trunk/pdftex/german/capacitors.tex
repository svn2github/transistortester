...
Nach dieser Kondensatormessung wird die Selbstantladung des Kondensators untersucht, indem der
Spannungsverlust  einer der Ladezeit proportionalen Zeit untersucht wird.
...
Der ESR Widerstand \cite{ESR} stellt zum Beispiel ein Ma"s f\"ur die Alterung von Elektrolyt-Kondensatoren dar.
...
Danach hat man drei Spanungssummen, die Spannung \(Ulp\) am Minuspol des Kondensators mit Strom, die Spannung \(Uhp\) am
