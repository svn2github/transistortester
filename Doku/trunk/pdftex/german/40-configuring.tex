...
,,make upload'' aufruft.
Die Software, die für einen ATmega8 übersetzt wurde, läuft nicht auf einem ATmega88.
Die Software, die für einen ATmega168 übersetzt wurde, läuft nicht auf einem ATmega88, sogar wenn
...
Markus F. lauffähig (PARTNO=m8 , keine NO\_AREF\_CAP und keine PULLUP\_DISABLE Option).
...
\begin{description}
  ...
  \item[UI\_LANGUAGE] gibt die Sprache für den Tester an:\\
    LANG\_ENGLISH, LANG\_GERMAN, LANG\_POLISH, LANG\_CZECH,  LANG\_SLOVAK und  LANG\_SLOVENE sind derzeit verfügbar.\\
...
können Sie die Mess-Wiederholung dennoch abbrechen, wenn Sie den Start-Knopf einige Sekunden gedückt halten 
...
Sie können auch angeben, nach wie vielen Messungen ohne gefundenes Bauteil der Tester ausschaltet.
...
Die Messresultate für eine Einzelmessung werden 10~Sekunden angezeigt, bei der Mehrfachmessung wird die
