...
\begin{description}
  ...
  \item[UI\_LANGUAGE] gibt die Sprache für den Tester an:\\
    LANG\_ENGLISH, LANG\_GERMAN, LANG\_POLISH, LANG\_CZECH, LANG\_SLOVAK, LANG\_SLOVENE, LANG\_DUTCH und LANG\_BRASIL sind derzeit verfügbar.\\
...
Sonst wird eine 0.4V höhere Warn-Spannung gewählt, bei unter 3.0V sogar nur eine 0.2V höhere Warn-Spannung und
