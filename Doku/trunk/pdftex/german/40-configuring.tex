...
I2C-Interface benutzt werden. Dafür muss die Konstante LCD\_INTERFACE\_MODE auf 2 gesetzt werden.\\
Beispiel: CFLAGS += -DLCD\_INTERFACE\_MODE=2
 \item[LCD\_I2C\_ADDR] Die I2C-Adresse des SSD1306-Controllers kann durch Vorbesetzen der Adresse LCD\_I2C\_ADDR
