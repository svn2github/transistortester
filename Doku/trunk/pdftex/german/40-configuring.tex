...
\begin{description}
  ...
  \item[UI\_LANGUAGE] gibt die Sprache für den Tester an:\\
    ...
    LANG\_LITHUANIAN, LANG\_POLISH, LANG\_RUSSIAN, LANG\_SLOVAK, LANG\_SLOVENE, Lang\_SPANISH, und LANG\_UKRAINIAN
...
Dafür muss die Variable WITH\_LCD\_ST7565 auf 1306 gesetzt werden.\\
...
I\textsuperscript{2}C-Interface benutzt werden. Dafür muss die Konstante LCD\_INTERFACE\_MODE auf 2 gesetzt werden.\\
