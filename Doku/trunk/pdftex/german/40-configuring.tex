...
beschrieben werden.
Anstelle des ST7565 Kontrollers kann auch der ähnliche SSD1306 Kontroller konfiguriert werden.
Dafür muß die Variable WITH\_LCD\_ST7565 auf 1306 gesetzt werden.\\
Beispiel: WITH\_LCD\_ST7565 = 1 
 \item[LCD\_INTERFACE\_MODE] Beim SSD1306 Kontroller kann anstelle des Standard SPI 4-wire Interface auch das
I2C Interface benutzt werden. Dafür muß die Konstante LCD\_INTERFACE\_MODE auf 2 gesetzt werden.\\
Beispiel: CFLAGS += -DLCD\_INTERFACE\_MODE=2
 \item[LCD\_I2C\_ADDR] Die I2C Adresse des SSD1306 Kontrollers kann durch Vorbesetzen der Adresse LCD\_I2C\_ADDR
...
der beiden Schalter-Signale oder durch Setzen der Option CHANGE\_ROTARY\_DIRECTION ändern.
