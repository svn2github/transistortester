...
Ein externer Kondensator mit wenigstens \(100 nF\) an Pin~1 und Pin~3 ist notwendig, um die Offset Spannung des analogen Komparators
zu kompensieren. Dies kann den Me"sfehler bei Kapazit\"atsmessungen bis zu \(40 \mu F\) reduzieren.
\end{enumerate}
