...
Die Ergebnisse für die AUTOSCALE\_ADC Version zeigen hier kaum Verbesserungs-Potential.
...
\centering
\input{../GNU/Mega8res}
\caption{Relativer Fehler in \% für Widerstands-Messungen mit ATmega8 }
\label{fig:mega8res}
\end{figure}
...
\caption{Relativer Fehler in \% für Widerstand-Messungen mit ATmega168 }
...
\begin{figure}[H]
  ...
  \end{subfigure}
\caption{Relativer Fehler in \% für Widerstands-Messungen}
\end{figure}

\begin{figure}[H]
\centering
\input{../GNU/m168pres_all}
\caption{Relativer Fehler in \% für Widerstands-Messungen mit drei ATmega168P }
