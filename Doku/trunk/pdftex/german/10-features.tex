...
\item Anzeige der Messergebnisse auf einem 2x16 oder 4x20 Zeichen großen LC-Display.
 ...
 mit 128x64 Pixel und ST7565- oder SSD1306-Controller benutzt werden. Dabei wird anstelle der Standard 4-Bit Parallel-Schnittstelle
 entweder eine 4-Wire \(SPI\)-Schnittstelle oder ein I\textsuperscript{2}C-Bus benutzt.
...
Ab Softwareversion 1.05k wird nach Möglichkeit in den Messpausen der Schlafzustand des ATmega168 oder ATmega328 zum Stromsparen benutzt.
...
\item Mit Dialogfunktion kann eine separate Kondensatormessung mit ESR-Messung gestartet werden.
 ...
 Hierbei sollte besonders darauf geachtet werden, dass die Kondensatoren vor der Messung keine Restladung mehr haben.
