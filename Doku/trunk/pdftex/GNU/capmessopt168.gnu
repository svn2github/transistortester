...
plot "../GNU/capmess168-3.dat" u 3:($4-$3)/$3*100 title "168-A" ls 1,"../GNU/capmess168-3.dat" u 3:($5-$3)/$3*100 title "168-B" ls 2,"../GNU/capmess168-3.dat" u 3:($6-$3)/$3*100 title "168-C" ls 3
set output
#    EOF
