...
plot "../GNU/rmess.dat" u 1:(($2-$1)/$1*100) title "Mega8" ls 1, "../GNU/rmess.dat" u 1:(($3-$1)/$1*100) title "Mega8as" ls 2, "../GNU/ormess.dat" u 1:(($2-$1)/$1*100) title "Mega8orig" ls 3
set output
set output "../GNU/Mega168res.eps"
plot "../GNU/rmess.dat" u 1:(($4-$1)/$1*100) title "Mega168" ls 1, "../GNU/rmess.dat" u 1:(($5-$1)/$1*100) title "Mega168as" ls 2
set output
#    EOF
